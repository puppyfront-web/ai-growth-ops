...
export const createContentItemSchema = z.object({
  ...
  type: z.enum(['text_image', 'video', 'article', 'answer']).default('text_image'),
...
export const batchGenerateVariantsSchema = z.object({
  platforms: z.array(z.enum(['douyin', 'xiaohongshu', 'wechat_official', 'wechat_channels', 'baijiahao', 'zhihu'])).min(1, '至少选择一个平台'),
});
