...
export default function ConversationDetailPage() {
  ...
  return (
    <div>
      <PageHeader
        title={conversation.externalUserName ?? conversation.externalUserId}
        description={`${conversation.interactions.length} 条消息`}
      />
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="rounded-xl border bg-card p-5">
            ...
            <div className="space-y-4">
              {conversation.interactions.map((msg) => (
                <div
                  key={msg.id}
                  className={`flex gap-3 ${msg.type === 'comment' ? '' : 'pl-8'}`}
                >
          ...
          <div className="rounded-xl border bg-card p-5">
            ...
            <div className="mt-3 flex gap-2">
              <button
                onClick={() =>
                  replyText.trim() && replyMutation.mutate(replyText)
                }
              ...
              <div className="space-y-3">
                ...
                <div className="mt-3">
                  ...
                  <div className="rounded-lg bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 p-3 text-sm">
                    {suggestion.suggestedReply || '风险过高，不建议自动回复'}
                  </div>
                  {suggestion.suggestedReply && (
                    <div className="mt-2 flex gap-2">
                      <button
                        onClick={() => setReplyText(suggestion.suggestedReply)}
